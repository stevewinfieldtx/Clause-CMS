...
export const TOTAL_OPS = ['set', 'replace_section', 'insert_section', 'remove_section', 'move_section', 'set_css'];
...
export function sanitizeFragment(html) {
  ...
  $('script, object, embed, base, link, meta, form, input, textarea, select').remove();
