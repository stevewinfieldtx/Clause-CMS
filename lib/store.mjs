...
export async function initStore() {
  // Accept Railway's native MongoDB var names too, so a reference var named
  // MONGO_URL (or MONGO_PUBLIC_URL) works without any renaming. MONGODB_URI wins if set.
